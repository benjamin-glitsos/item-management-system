...
// TODO: finish the first query-functions.sql function then after finishing the endpoints you can check to remove some more redundancies from the SQL code

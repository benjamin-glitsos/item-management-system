...
// TODO: make UsersServices and UsersDAO files split a separate file per method and then 'extend' those objects into the UsersServices and UsersDAO objects to extend their methods, for loose coupling.
